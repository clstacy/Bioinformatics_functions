...
#'
#' @examples
#' merge_blast2go_gene_list("blast2go_output.txt", "gene_list.txt", "merged_data.tsv")
#'
#' @seealso https://www.blast2go.com/
#' @seealso https://en.wikipedia.org/wiki/Gene_ontology
merge_blast2go_gene_list <- function(blast2go_file, gene_list_file, merged_file) {
  ...
  colnames(blast2go) <- c("Gene_ID", "Sequence_Length", "Sequence_Name", "E_Value", "Hit_ID", "Hit_Name", 
"Hit_Description", "GO")
